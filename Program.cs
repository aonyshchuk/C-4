            ...
            while (Input)
            {
                ...
                switch (task)
                {
                    case 1:
                        ...
                        FibonacciGenerator fibonaccinumberGenerator = new FibonacciGenerator();


                        Console.WriteLine("Парні числа:");
                        for (int i = 0; i < 5; i++)
                        {
                            int evenNumber = evennumbergenerator.GenerateNext();
                        ...
                        for (int i = 0; i < 5; i++)
                        {
                            int oddNumber = oddnumberGenerator.GenerateNext();
                        ...
                        for (int i = 0; i < 5; i++)
                        {
                            int primeNumber = primenumberGenerator.GenerateNext();
                        ...
                        for (int i = 1; i <= 5; i++)
                        {
                            int fibonacciNumber = fibonaccinumberGenerator.GenerateNext(i);
